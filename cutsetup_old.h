    ...
    UnIntVariable[2].stability = 0;
    UnIntVariable[2].cuttype = rightonly;
    UnIntVariable[2].trigger.orTerm = true;
    ...
    UnIntVariable[8].stability = 0;
    UnIntVariable[8].cuttype = rightonly;
    UnIntVariable[8].trigger.orTerm = true;
    ...
    UnIntVariable[8].trigger.termCount = 2;
